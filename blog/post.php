...
<body>
	<form class="category" method="POST">
		...
		Published at:<input type="date" name="publish" id="publish" required=""><br><br>
		Category:<select name="category" id="category" required="" multiple="">
